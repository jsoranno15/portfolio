...
export const AboutBox = () => {
  const className =
    "bg-gradient-to-r from-ds-white  to-ds-cyan text-transparent bg-clip-text w-fit flex flex-row gap-2 justify-center  ";
  return (
    <div
    ...
    >
      ...
      >
        ...
        />
        <div className="flex  w-full items-center text-center z-[2] flex-col p-8 text-3xl font-bold gap-[50px]  justify-center h-full">
          <span className={`${className} `}>
            <div className="size-8 text-ds-white ">
              <PersonIcon2 />
            </div>
            Juliana Soranno
          </span>

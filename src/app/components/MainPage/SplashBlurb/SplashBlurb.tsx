  ...
  return (
    ...
    >
      <div className="flex flex-col text-center items-center">
        <span
          className="absolute  text-[66px] md:text-[96px] leading-[96px] font-black  mx-auto py-4 flex  w-fit  bg-[#12161e] 
        blur-xl opacity-100  bg-clip-text  box-content  text-transparent text-center select-none"
        >
          Juliana Soranno
        </span>
        <h1
          className="relative  text-[46px] leading-[46px] md:text-[96px] md:leading-[96px] font-black  top-0 w-fit h-auto py-4 justify-center flex bg-white

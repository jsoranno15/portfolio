  ...
  return (
    <div className="flex flex-col gap-2 text-sm md:w-2/3">
      <span>
        ...
        of her tasks and
        <span className="text-ds-main-accent"> extremely reliable,</span>{" "}
        delivering work in the best possible way. One of the most impressive
        traits of Juliana as a colleague is her ability to
        <span className="text-ds-main-accent"> learn and adapt quickly, </span>
      ...
      <span>
        ...
        <span className="text-ds-main-accent"> highly communicative, </span>
        very friendly, and super fun to work with, thanks to her lively
        personality. She has a great
        <span className="text-ds-main-accent"> professional attitude, </span>
